...
PROD=170201
JOBDIR=/vols/cms/rd1715/HiggsToInv/jobs_lighttree_170707_SingleMuonAndElectron_MuEGClean/
#JOBDIR=/vols/cms/rd1715/HiggsToInv/jobs_lighttree_170710/
INJOBDIR=0
...
while [ $# -gt 0 ] ; do
    ...
    case $1 in
        -h|--help|-help)
            echo "usage: "$0"  [-d <job directory>] [-p <prod>]"
            exit 1;
            ;;
        -d)
	JOBDIR=$2
