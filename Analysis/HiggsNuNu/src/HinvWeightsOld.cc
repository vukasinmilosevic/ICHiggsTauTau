...
namespace ic {//namespace
  ...
  HinvWeightsOld::HinvWeightsOld(std::string const& name) : ModuleBase(name),
    mc_(mc::summer12_53X),
  ...
  HinvWeightsOld::~HinvWeightsOld() {
    ;
  }

  int HinvWeightsOld::PreAnalysis() {
    std::cout << "--------------------------------------" << std::endl;
    std::cout << "-- PreAnalysis Info for HinvWeightsOld --" << std::endl;
    std::cout << "--------------------------------------" << std::endl;
  ...
  int HinvWeightsOld::Execute(TreeEvent *event) {
...
//       }
  ...
  int HinvWeightsOld::PostAnalysis() {
    if (save_weights_) {
    std::cout << "---------------------------------------" << std::endl;
    std::cout << "-- PostAnalysis Info for HinvWeightsOld --" << std::endl;
    std::cout << "---------------------------------------" << std::endl;
  ...
  void HinvWeightsOld::PrintInfo() {
    ;
  }

  void HinvWeightsOld::SetWTargetFractions(double f0, double f1, double f2, double f3, double f4) {
    f0_ = f0;
    f1_ = f1;
    f2_ = f2;
    f3_ = f3;
  ...
  void HinvWeightsOld::SetWTargetFractions(double f0, double f1, double f2, double f3, double f4, double f5, double f6, double f7) {
    f0_ = f0;
    f1_ = f1;
    f2_ = f2;
    f3_ = f3;
  ...
  void HinvWeightsOld::SetWInputYields(double n_inc, double n1, double n2, double n3, double n4) {
    n_inc_ = n_inc;
    n1_ = n1;
    n2_ = n2;
    n3_ = n3;
  ...
  void HinvWeightsOld::SetWInputYields(double n_inc, double n1, double n2, double n3, double n4, double n5, double n6, double n7) {
    n_inc_ = n_inc;
    n1_ = n1;
    n2_ = n2;
    n3_ = n3;
  ...
  void HinvWeightsOld::SetDYTargetFractions(double zf0, double zf1, double zf2, double zf3, double zf4) {
    zf0_ = zf0;
    zf1_ = zf1;
    zf2_ = zf2;
    zf3_ = zf3;
  ...
  void HinvWeightsOld::SetDYInputYields(double zn_inc, double zn1, double zn2, double zn3, double zn4) {
    zn_inc_ = zn_inc;
    zn1_ = zn1;
    zn2_ = zn2;
    zn3_ = zn3;
  ...
  unsigned HinvWeightsOld::getPartonNumber(std::vector<GenParticle*> const& parts){
  ...
  double HinvWeightsOld::Efficiency(double m, double m0, double sigma, double alpha, double n, double norm){
  ...
  unsigned HinvWeightsOld::findPtEtaBin(const double & aPt, const double & aEta, const std::vector<double> & ptbinvec, const std::vector<double> & etabinvec){
  ...
  void HinvWeightsOld::fillVector(const std::string & aFileName, 
  ...
  double HinvWeightsOld::nloReweighting(const double & aMjj, const double & aYstar){
