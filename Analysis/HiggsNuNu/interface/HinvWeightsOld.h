#ifndef ICHiggsTauTau_Module_HinvWeightsOld_h
#define ICHiggsTauTau_Module_HinvWeightsOld_h
...
class HinvWeightsOld : public ModuleBase {
 private:
  CLASS_MEMBER(HinvWeightsOld, fwlite::TFileService*, fs);
  CLASS_MEMBER(HinvWeightsOld, ic::mc, mc)
  CLASS_MEMBER(HinvWeightsOld, ic::era, era)
  CLASS_MEMBER(HinvWeightsOld, bool, save_weights)
  CLASS_MEMBER(HinvWeightsOld, bool, save_lumixs_weights)  
  CLASS_MEMBER(HinvWeightsOld, bool, do_top_reweighting)
  CLASS_MEMBER(HinvWeightsOld, bool, do_trg_weights)
  CLASS_MEMBER(HinvWeightsOld, bool, do_binnedin2d1dfittedtrg_weights)
  CLASS_MEMBER(HinvWeightsOld, std::vector<std::string>, binnedin2d1dfitweightvarorder)//bin in first two fit in 3rd
  CLASS_MEMBER(HinvWeightsOld, std::vector<double>, binnedin2d1dfitweightvar1binning)//binning of first var
  CLASS_MEMBER(HinvWeightsOld, std::vector<double>, binnedin2d1dfitweightvar2binning)//binning of second var
  CLASS_MEMBER(HinvWeightsOld, bool, do_metmht)


  CLASS_MEMBER(HinvWeightsOld, bool, trg_applied_in_mc)
  CLASS_MEMBER(HinvWeightsOld, bool, do_idiso_tight_weights)
  CLASS_MEMBER(HinvWeightsOld, bool, do_idiso_veto_weights)
  CLASS_MEMBER(HinvWeightsOld, bool, do_w_soup)
  CLASS_MEMBER(HinvWeightsOld, bool, do_w_reweighting)
  CLASS_MEMBER(HinvWeightsOld, bool, do_ewk_w_reweighting)
  CLASS_MEMBER(HinvWeightsOld, bool, do_dy_soup)
  CLASS_MEMBER(HinvWeightsOld, bool, do_dy_soup_htbinned)
  CLASS_MEMBER(HinvWeightsOld, bool, do_dy_reweighting)
  CLASS_MEMBER(HinvWeightsOld, bool, do_ewk_dy_reweighting)
  CLASS_MEMBER(HinvWeightsOld, std::string, input_met)
  CLASS_MEMBER(HinvWeightsOld, std::string, input_jet)
  CLASS_MEMBER(HinvWeightsOld, bool, do_lumixs_weights)
  CLASS_MEMBER(HinvWeightsOld, std::string, input_params)
  CLASS_MEMBER(HinvWeightsOld, std::string, sample_name)
  CLASS_MEMBER(HinvWeightsOld, std::string, trg_weight_file)

  // For v_nlo_Reweighting (kfactors.root file in input/scalefactors from MIT group)
  CLASS_MEMBER(HinvWeightsOld, std::string, kfactors_wjets_file)
  CLASS_MEMBER(HinvWeightsOld, std::string, kfactors_zjets_file)
  ...
  CLASS_MEMBER(HinvWeightsOld, std::string, kFactor_ZToNuNu_pT_Mjj_file)
  CLASS_MEMBER(HinvWeightsOld, std::string, kFactor_WToLNu_pT_Mjj_file)
 ...
 public:
  HinvWeightsOld(std::string const& name);
  virtual ~HinvWeightsOld();
