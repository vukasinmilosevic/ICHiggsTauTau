...
echo "JOB name = $JOB"
for syst in BTAGUP BTAGDOWN #JESUP JESDOWN JERBETTER JERWORSE BTAGUP BTAGDOWN LEPEFF_ELEUP LEPEFF_ELEDOWN LEPEFF_GSFUP LEPEFF_GSFDOWN LEPEFF_MUUP LEPEFF_MUDOWN PUUP PUDOWN TRIGUP TRIGDOWN UESUP UESDOWN
