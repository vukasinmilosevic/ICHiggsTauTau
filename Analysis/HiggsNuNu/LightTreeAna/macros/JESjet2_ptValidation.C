...
int JESjet2_ptValidation(){//main
  ...
  std::string nunu_JESUP_file   = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESUP/nunu.root";
  std::string nunu_JESDOWN_file = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESDOWN/nunu.root";
  ...
  std::string enu_JESUP_file   = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESUP/enu.root";
  std::string enu_JESDOWN_file = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESDOWN/enu.root";
  ...
  std::string munu_JESUP_file   = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESUP/munu.root";
  std::string munu_JESDOWN_file = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESDOWN/munu.root";
  ...
  std::string taunu_JESUP_file   = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESUP/taunu.root";
  std::string taunu_JESDOWN_file = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESDOWN/taunu.root";
  ...
  std::string mumu_JESUP_file   = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESUP/mumu.root";
  std::string mumu_JESDOWN_file = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESDOWN/mumu.root";
  ...
  std::string ee_JESUP_file   = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESUP/ee.root";
  std::string ee_JESDOWN_file = "/home/hep/rd1715/CMSSW_8_0_25/src/UserCode/ICHiggsTauTau/Analysis/HiggsNuNu/LightTreeAna/output_run2ana_170308/JESDOWN/ee.root";
...
//********************************************************************************************************************************************************
    ...
    nunuWmunuQCD_JESDOWN_ratio_hist->SetLineColor(kRed);
    // ********* Ratio_Hits *********
    ...
    TH1F * munu_nunu_QCD_JESUP_ratio_hist   = (TH1F*)munuQCD_JESUP_ratio_hist->Clone();
    TH1F * munu_nunu_QCD_JESDOWN_ratio_hist   = (TH1F*)munuQCD_JESDOWN_ratio_hist->Clone();
    munu_nunu_QCD_JESUP_ratio_hist->Divide(nunuWmunuQCD_JESUP_ratio_hist);
    munu_nunu_QCD_JESUP_ratio_hist->SetLineColor(kOrange);
    munu_nunu_QCD_JESDOWN_ratio_hist->Divide(nunuWmunuQCD_JESDOWN_ratio_hist);
...
//     nunuWenuQCD_JESDOWN_hist    ->Scale(1./nunuWenuQCD_JESDOWN_hist->Integral());
    ...
    for( unsigned ibin_munuQCD_hist=1; ibin_munuQCD_hist<=nbins_munuQCD_hist; ibin_munuQCD_hist++, iter_munuQCD_hist++){
      ...
      double munuQCD_JESUP_hist_binC = munuQCD_JESUP_hist->GetBinContent(ibin_munuQCD_hist);
      double munuQCD_JESDOWN_hist_binC = munuQCD_JESDOWN_hist->GetBinContent(ibin_munuQCD_hist);
      ...
      if ( munuQCD_JESUP_hist_binC > munuQCD_JESDOWN_hist_binC ){
        yue_munuQCD_hist[iter_munuQCD_hist] = munuQCD_JESUP_hist_binC - munuQCD_hist_binC ;
        yde_munuQCD_hist[iter_munuQCD_hist] = munuQCD_hist_binC - munuQCD_JESDOWN_hist_binC ;
      } else if ( munuQCD_JESUP_hist_binC < munuQCD_JESDOWN_hist_binC ){
        yue_munuQCD_hist[iter_munuQCD_hist] = munuQCD_JESDOWN_hist_binC - munuQCD_hist_binC ;
        yde_munuQCD_hist[iter_munuQCD_hist] = munuQCD_hist_binC - munuQCD_JESUP_hist_binC ;
    ...
    for( unsigned ibin_nunuWmunuQCD_hist=1; ibin_nunuWmunuQCD_hist<=nbins_nunuWmunuQCD_hist; ibin_nunuWmunuQCD_hist++, iter_nunuWmunuQCD_hist++){
      ...
      double nunuWmunuQCD_JESUP_hist_binC = nunuWmunuQCD_JESUP_hist->GetBinContent(ibin_nunuWmunuQCD_hist);
      double nunuWmunuQCD_JESDOWN_hist_binC = nunuWmunuQCD_JESDOWN_hist->GetBinContent(ibin_nunuWmunuQCD_hist);

//       cout << " nunuWmunuQCD_hist_binC         " << nunuWmunuQCD_hist_binC          << endl;
//       cout << " nunuWmunuQCD_JESUP_hist_binC   " << nunuWmunuQCD_JESUP_hist_binC    << endl;
//       cout << " nunuWmunuQCD_JESDOWN_hist_binC " << nunuWmunuQCD_JESDOWN_hist_binC  << endl;
      ...
      if ( nunuWmunuQCD_JESUP_hist_binC > nunuWmunuQCD_JESDOWN_hist_binC ){
        yue_nunuWmunuQCD_hist[iter_nunuWmunuQCD_hist] = nunuWmunuQCD_JESUP_hist_binC - nunuWmunuQCD_hist_binC ;
        yde_nunuWmunuQCD_hist[iter_nunuWmunuQCD_hist] = nunuWmunuQCD_hist_binC - nunuWmunuQCD_JESDOWN_hist_binC ;
      } else if ( nunuWmunuQCD_JESUP_hist_binC < nunuWmunuQCD_JESDOWN_hist_binC ){
        yue_nunuWmunuQCD_hist[iter_nunuWmunuQCD_hist] = nunuWmunuQCD_JESDOWN_hist_binC - nunuWmunuQCD_hist_binC ;
        yde_nunuWmunuQCD_hist[iter_nunuWmunuQCD_hist] = nunuWmunuQCD_hist_binC - nunuWmunuQCD_JESUP_hist_binC ;
      } else std::cout << " -- ERROR: something is going on ... ";
    }
    ...
    nunuWmunuQCD_JESUP_hist      ->SetName("nunuWmunuQCD_JESUP_hist");
    nunuWmunuQCD_hist            ->SetName("Signal Region: QCD W#mu#nu process");
    nunuWmunuQCD_JESDOWN_hist    ->SetName("nunuWmunuQCD_JESDOWN_hist");
    ...
    nunuWmunuQCD_JESUP_hist      ->SetTitle("nunuWmunuQCD_JESUP_hist");
