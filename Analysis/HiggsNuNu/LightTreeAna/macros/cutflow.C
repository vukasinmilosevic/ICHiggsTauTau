...
int cutflow(){
  ...
  const unsigned nF = 4;
  TFile *fin[nF];
  fin[0] = TFile::Open("output_lighttree_170111_noskim/MC_EWKZ2Jets_ZToNuNu.root");
  fin[1] = TFile::Open("output_lighttree_170111_noskim/MC_EWKWPlus2Jets_WToLNu.root");
  fin[2] = TFile::Open("output_lighttree_170111_noskim/MC_EWKZ2Jets_ZToLL.root");
  fin[3] = TFile::Open("output_lighttree_161031_ICHEP_forSYNCH/MC_Powheg-VBFHtoinv-mH125.root");
  ...
  TH2F *hsummary = new TH2F("hsummary",";run;cut",4,-1.5,2.5,nC,0,nC);
