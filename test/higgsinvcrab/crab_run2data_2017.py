...
#            crabCommand('status')
    ...
    tasks.append(('MET-2016D-ReReco-v1'                ,'/MET/Run2016D-23Sep2016-v1/MINIAOD'             ,rerecoparams,  ))
    ...
    tasks.append(('SingleMuon-2016D-ReReco-v1'         ,'/SingleMuon/Run2016D-23Sep2016-v1/MINIAOD'      ,rerecoparams,  ))
    ...
    tasks.append(('SingleElectron-2016D-ReReco-v1'     ,'/SingleElectron/Run2016D-23Sep2016-v1/MINIAOD'  ,rerecoparams,  ))
